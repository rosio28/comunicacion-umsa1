...
<?php
// ============================================================
// ROUTER PRINCIPAL — api/index.php
// ============================================================
...
try {
    match(true) {
        ...
        $r0==='eventos' && $r1  && $method==='PUT'  => (new EventosController)->update((int)$r1),
        $r0==='eventos' && $r1  && $method==='DELETE' => (new EventosController)->destroy((int)$r1),
        ...
        $r0==='whatsapp' && $r1  && $method==='PUT'  => (new WhatsappController)->update((int)$r1),
        $r0==='whatsapp' && $r1  && $method==='DELETE' => (new WhatsappController)->destroy((int)$r1),
        ...
        $r0==='usuarios' && $r1  && $method==='PUT'  => (new UsuariosController)->update((int)$r1),
